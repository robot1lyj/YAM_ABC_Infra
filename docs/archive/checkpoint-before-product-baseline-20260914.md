...
- 证据：[NVMe 与迁移](../evidence/20260914-rk3588-ipc-nvme.txt)；记录：[rk3588-ipc-nvme-20260914](../cache/records/rk3588-ipc-nvme-20260914.json)。未启动电机、CAN、相机或 Thor 推理。
...
- 本地与 IPC `/data/YAM/configs/cameras.yaml` 已更新；报告、规则和验证输出见 [相机身份证据](../evidence/20260914-rk3588-ipc-cameras.txt) 及记录 [rk3588-ipc-cameras-20260914](../cache/records/rk3588-ipc-cameras-20260914.json)。没有启动相机流、CAN、机械臂或 Thor。
