...
| IPC gs_usb驱动、重复激活失联、USB/xHCI错误、NVMe启动Link Fail | [硬件事实](../workstation.md)、[安装与回滚](../environment.md#2026-09-22-生命周期修复已加载) | [9月22日核查与修复](../evidence/20260922-ipc-usb-nvme.md)、[实测](../evidence/20260922-gs-usb-repair.json)；gs_usb已修，NVMe根因未定，换内核/USB拓扑后重查 |
