...
设备本体S/N、USB-CAN适配器S/N、Hub物理端口、系统通道名、相机S/N分别记录，附观察时间、证据和重查条件；系统枚举号不冒充稳定身份。当前登记入口为 [P0设备身份](workstation.md#第一步设备身份登记-p0)。condapi读取快照必须包含本地HEAD/文件指纹及范围，归本仓库接口owner，不在这里复制一套训练事实。
