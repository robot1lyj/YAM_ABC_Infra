...
- 2026-09-14 已完成四臂1–6号电机逐个通讯/OFF及左follower官方零重力初始化；左
  `linear_4310`自动标定跨度约5.665 rad，标定后10秒最大关节漂移约0.018 rad且CAN无
  错误。右follower、两leader、现场手感和遥操作仍未验收；未写零位或发送全零Home。
  适用范围与无效`no_gripper`对照见[P3左臂证据](evidence/20260914-rk3588-p3-left-init.json)。
