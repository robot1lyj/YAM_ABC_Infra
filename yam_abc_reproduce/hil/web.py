...
<div><button onclick="send('mode:teleop')">遥操作</button><button onclick="send('mode:inference')">推理</button><button onclick="send('mode:hil')">DAgger / HIL</button></div>
...
<p>Leader 顶部按钮：接管 / 交还；第二按钮：保持。退出程序会结束电机控制，请先支撑机械臂。</p>
